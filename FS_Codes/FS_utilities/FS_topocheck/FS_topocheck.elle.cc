...
int TopologyChecks()
{
    ...
    printf("Emma L debugging...");
    iError = CheckNodesCoincide2(); 
    cout<<"Emma L iError: "<<iError<<endl;
    //if (iError) OnError("Emma L 1 Error in CheckNodesCoincide",iError);
    ...
    //if (iError) OnError("Emma 2 Error in CheckNodesCoincide",iError);
