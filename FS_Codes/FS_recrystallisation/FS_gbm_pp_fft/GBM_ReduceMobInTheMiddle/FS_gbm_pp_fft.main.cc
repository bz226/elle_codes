...
int main(int argc, char **argv)
{
     ...
     */
    ElleInit();
    ElleSetOptNames("diagonal","afactor","logscreen","Start Timestep","ExcludePhase","dMobLoweringFact","unused","unused","unused");
    /* 
    ...
    userdata[5] = 1.0; // by default, the reduction factor is 1
