...
# operating system:  Linux 4.4.0-142-generic x86_64 [ELF] (4.4.0)
# libc:	(6.27.0)
# binutils:	(230)
...
SUBDIRS = statscode basecode utilities processes
SUBDIRS_BASE = basecode utilities
SUBDIRS_B = basecode utilities processes
SUBDIRS_X = basecode utilities processes
SUBDIRS_WX = basecode utilities processes
